...
#
LSCRIPT = kernel.lds
OBJ = start.o src/drv/dbgu.o src/demo/dbgu_demo.o src/lib/print.o src/lib/printf.o src/drv/mc.o src/drv/aic.o src/drv/st.o src/demo/mc_demo.o src/lib/io.o src/sys/ivt.o src/sys/init.o src/lib/exception_handler.o
